  ...
  return (
    <main className="relative z-0 w-screen h-screen ">
      <div
        ...
        } hidden md:flex transition-all duration-500 ease-in-out absolute z-50 w-full h-full flex flex-col justify-center items-center gap-20 bg-black/70`}
      >
      ...
      <Climber />
      <div className=" hidden px-4 py-3 md:flex flex-col items-center gap-4 absolute top-10 right-10 z-50 bg-sky-600 rounded-2xl border-2 border-sky-300 shadow-md shadow-black">
